    ...
    return (
      <div style={s.center}>
        <span
          ...
          style={{ fontSize: "3rem", color: "#B4280D" }}
        >
          error_outline
        </span>
        <p style={{ color: "#555", margin: "0.75rem 0" }}>{error}</p>
        <button style={s.btnRed} onClick={() => window.location.reload()}>
          Reintentar
        </button>
      </div>
    );
      ...
      <div style={s.container}>
        <div style={s.header}>
          <div>
            ...
            <p style={s.subtitle}>
              Hola, <strong>{user?.fullName}</strong> — gestioná tus estadías
            </p>
          </div>
          <button
            style={s.btnExplore}
        ...
        {filtered.length === 0 && (
          <div style={s.emptyBox}>
            <span
              className="material-icons"
              style={{ fontSize: "3.5rem", color: "#ddd" }}
            >
              hotel
            </span>
            ...
            <p style={s.emptySub}>
              {filter === "all" &&
                "Explorá nuestras habitaciones y encontrá tu próximo destino."}
            </p>
            {filter === "all" && (
              <button
                style={s.btnRed}
        ...
        <div style={s.cardsList}>
          {filtered.map((r) => {
            ...
            return (
              <div
                key={r._id}
                style={{ ...s.card, ...(st === "cancelled" ? s.cardDim : {}) }}
              >
                <div style={s.cardImgWrap}>
                  {r.room?.images?.[0] ? (
                    ...
                    <div style={s.cardImgFallback}>
                      <span
                        className="material-icons"
                        style={{ fontSize: "2.5rem", color: "#ddd" }}
                      >
                        hotel
                      </span>
                    </div>
                ...
                <div style={s.cardBody}>
                  ...
                  <div style={s.datesRow}>
                    <div style={s.dateItem}>
                      <span className="material-icons" style={s.dateIcon}>
                        flight_land
                      </span>
                      <div>
                  ...
                  {st === "active" && (
                    <div style={{ ...s.actions }}>
                      <div style={s.activePill}>
                        ...
                        ¡Disfrutá tu estadía! Quedan {getDaysUntil(r.checkOut)}{" "}
                        días
                      </div>
                    </div>
                  )}
